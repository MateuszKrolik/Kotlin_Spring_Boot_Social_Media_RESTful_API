...
[![hal_explorer](images/hal_explorer.jpeg)](https://mkrolik-spring-social-api-zkxyiin4mq-ew.a.run.app/explorer/index.html)
...
![neon](images/neon.jpeg)

## PgSQL ERD Diagram Schema Visualization (PgAmin4):
...
Password: social-media-user-password
```
...
# for local development using my docker-run-postgres.sh BASH script
# (or a commented out part of my docker-compose.yml file)
# but first you need to run chmod +x to be able execute it
POSTGRES_PASSWORD = YOUR_POSTGRES_PASSWORD;
```

4. When deploying remember to create a GitHub master branch trigger in GCP Cloud Build, and don't forget to set all the necessary IAM Roles using my BASH script for the Default User or use the Script for a Custom One:
...
- [x] Relative Links in API Responses via HATEOAS
...
- [x] Basic Authentication & Authorization using Spring Security Framework
